...
import com.fitness.models.Participant;
...
public class ParticipantOperations {
	 ...
	 private Connection connection = null;
	    ...
	    public String addNewParticipant(Participant participant) throws SQLException {
	        String result = "Err";
	        try {
	            preparedStatement = connection.prepareStatement("INSERT INTO Participant(name, phone, email, bid) VALUES (?, ?, ?, ?)");
	    ...
	    public Participant searchParticipant(int pid) {
	        Participant participant = null;
	        try {
	            preparedStatement = connection.prepareStatement("SELECT * FROM Participant WHERE pid = ?");
	    ...
	    public String deleteParticipantsByBatchId(int bid) throws SQLException {
	        String result = "Err";
	        try {
	            preparedStatement = connection.prepareStatement("DELETE FROM Participant WHERE bid = ?");
