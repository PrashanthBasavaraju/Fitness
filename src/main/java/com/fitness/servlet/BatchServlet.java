...
import com.fitness.dbOperations.BatchOperations;
import com.fitness.dbOperations.ParticipantOperations;
	...
	private void handleDelete(HttpServletRequest request, HttpServletResponse response)
	    ...
	    if (bidStr != null) {
	        ...
	        try {
	            ...
	            // Delete participants associated with the batch
	            ParticipantOperations participantOperations = new ParticipantOperations();
	            participantOperations.deleteParticipantsByBatchId(bid); // Implement this method
